...
conn = sqlite3.connect('formula_1H.db')
cur = conn.cursor()
conn.execute('CREATE TABLE formula_1h(Formula TEXT, cid INTEGER, structure_imageurl TEXT, hnmr_imageurl TEXT)')
query = "insert into formula_1h values(:Formula, :cid, :structure_imageurl, :hnmr_imageurl)"
parameters = ({"Formula":chemformula,
              ...
              "hnmr_imageurl" : formula_1H(formula_cid_result)})
